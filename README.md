...
This version of the LaunchDarkly SDK is compatible with Python 3.8 through 3.11. It is tested with the most recent patch releases of those versions. Python versions 2.7 to 3.6 are no longer supported.
