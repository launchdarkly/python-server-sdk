...
- **Async persistent feature stores — foundation + Redis ✅ MERGED (#488, SDK-2905); DynamoDB/Consul pending.**
  ...
  and the released sync Redis stores. DynamoDB (SDK-2906) and Consul (SDK-2907) stack on that foundation
  and are queued (held until SDK-2905 gets initial feedback). While finishing them, fix the
